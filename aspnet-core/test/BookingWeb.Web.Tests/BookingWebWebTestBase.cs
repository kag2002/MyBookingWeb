...
{
    public abstract class BookingWebWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BookingWebWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BookingWebWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BookingWebDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BookingWebDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BookingWebDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BookingWebDbContext, Task<T>> func)
        {
            T result;
